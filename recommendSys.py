...
def run():
    ...
    evaluate_training_model(training_model, 'test1.txt', 'result1.txt')
    print('Evaluate test2')
    evaluate_training_model(training_model, 'test2.txt', 'result2.txt')
    print('Evaluate test3')
    evaluate_training_model(training_model, 'test3.txt', 'result3.txt')
